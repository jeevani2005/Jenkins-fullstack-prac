...
const PatientManager = () => {
  ...
  const baseUrl = `${config.url}/patientapi`;
    ...
    <div className="patient-container">
      ...
      <div>
        ...
        <div className="form-grid">
          ...
          <input type="text" name="doctor" placeholder="Doctor Assigned" value={patient.doctor} onChange={handleChange} />
          {/* Kept only admissionDate */}
          <input type="date" name="admissionDate" value={patient.admissionDate} onChange={handleChange} />
